...
server.config["ONTOLOGY_FOLDER"] = "./data/ontology"
...
app.layout = dmc.MantineProvider([
    ...
    dcc.Store("selected-reports",data=None,storage_type='session'),
    dcc.Store("selected-project",data=None,storage_type='session'),
    dcc.Store("login",storage_type='session'),
    dcc.Location("global-url",refresh=True),
    dcc.Location("only-refresh",refresh=False), # only used to refresh active page
